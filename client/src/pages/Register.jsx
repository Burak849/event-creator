...
<p class="mt-1 text-sm text-gray-500 " id="file_input_help">SVG, PNG, JPG or GIF (MAX. 800x400px).</p>
                  ...
                  <div>
                    <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 ">Kullanıcı Adı</label>
                  ...
                  <a className="text-xs pt-5" href="/login">Hesabınız varsa giriş yapın</a>
                </form>
              </div>
            </div>
          </div>
